...
//        testLabel.text = "哈2"
    ...
    func setupSlider() {
        ...
        let slider:SliderButtonView = SliderButtonView(titleArray: ["111", "222"], width: 320, slectColor: UIColor.orangeColor(), unSelectColor: UIColor.blueColor())
            
            //) SliderButtonView(titleArray: ["111", "222"], width: 320, s)
